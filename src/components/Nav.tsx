    ...
    <nav className="flex flex-wrap justify-between items-center z-10 relative">
      ...
      <button
        ...
        className="dark:text-gray-400 dark:hover:bg-gray-700
         lg:hidden hover:bg-gray=100 p-2 focus:ring-2 focus:ring-gray-200 rounded-lg"
      >
        <RxHamburgerMenu size={25} />
      </button>
      <div className={`${isMobileMenu || "hidden"} w-full lg:w-auto lg:block`}>
        <ul
          className="lg:space-x-8 flex flex-col lg:flex-row
           bg-gray-50 text-lg border border-gray-100 rounded-lg
